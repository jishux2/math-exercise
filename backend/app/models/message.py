...
from ..utils.date_utils import get_cn_now
...
class Conversation(Base):
    ...
    created_at = Column(DateTime, default=get_cn_now)
...
class ConversationParticipant(Base):
    ...
    joined_at = Column(DateTime, default=get_cn_now)
...
class Message(Base):
    ...
    created_at = Column(DateTime, default=get_cn_now, index=True)
